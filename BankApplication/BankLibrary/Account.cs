...
namespace BankLibrary
{
    public abstract class Account : IAccount
    {
        ...
        protected int _percentage; // Переменная для хранения процентов
        ...
        // вызов отдельных событий. Для каждого событияя определяется свой виртуальный метод
        ...
        {
            OnOpened(new AccountEventArgs("Счет: " + _id + " закрыт. Итоговая сумма: " + CurrentSum, CurrentSum));
        }
